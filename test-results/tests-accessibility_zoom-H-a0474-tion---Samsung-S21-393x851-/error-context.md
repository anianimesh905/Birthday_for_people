...
- Name: tests\accessibility_zoom.spec.js >> Hogwarts Birthday Scrapbook - Accessibility Zoom & Responsiveness Verification >> Responsiveness verification - Samsung S21 (393x851)
...
- generic [active] [ref=e1]:
  ...
  - toolbar "Hogwarts Control Dock" [ref=e47]:
    ...
    - button "Cast Spell" [ref=e49] [cursor=pointer]
    - button "Toggle background music" [ref=e50] [cursor=pointer]
  - dialog "Choose Your House" [ref=e51]:
    - generic [ref=e52]:
      - heading "Choose Your House" [level=2] [ref=e53]
      - radiogroup "Choose Hogwarts House" [ref=e54]:
        - radio "Select Gryffindor" [ref=e55] [cursor=pointer]:
          - generic:
            - img "Gryffindor Crest"
            - generic: Gryffindor
        - radio "Select Slytherin" [ref=e56] [cursor=pointer]:
          - generic:
            - img "Slytherin Crest"
            - generic: Slytherin
        - radio "Select Ravenclaw" [ref=e57] [cursor=pointer]:
          - generic:
            - img "Ravenclaw Crest"
            - generic: Ravenclaw
        - radio "Select Hufflepuff" [ref=e58] [cursor=pointer]:
          - generic:
